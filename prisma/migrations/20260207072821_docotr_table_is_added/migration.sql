...
-- CreateIndex
CREATE INDEX "idx_doctor_speciality_doctorId" ON "doctorSpecialty"("doctorId");

-- CreateIndex
CREATE INDEX "idx_doctor_speciality_specialtyId" ON "doctorSpecialty"("specialtyId");
...
-- AddForeignKey
ALTER TABLE "doctorSpecialty" ADD CONSTRAINT "doctorSpecialty_specialtyId_fkey" FOREIGN KEY ("specialtyId") REFERENCES "speciality"("id") ON DELETE CASCADE ON UPDATE CASCADE;
